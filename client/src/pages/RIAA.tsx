  ...
  return (
    <>
      {/* ── Floating trigger button ──
           Mobile: icon-only pill, bottom-right corner (smaller margin)
      ...
      {/* ── Modal ──
           ...
           Tablet (sm-lg): centered modal, 88 vw, max 700 px
        ...
        {open && (
          <motion.div
            className={[
              ...
              /* mobile: anchor to bottom edge */
              "items-end inset-x-0 bottom-0",
              /* tablet+: center in viewport */
          ...
          >
            <motion.div
              className={[
                ...
                /* mobile: rounded top corners only (sheet style) */
                "rounded-t-2xl",
              ...
              /* mobile slides up; tablet/laptop scales + rises gently */
            ...
            >
              ...
              <div className="shrink-0 flex items-center justify-between px-4 sm:px-5 py-3 border-b border-[#e5e7eb] bg-white">
                <div>
                  ...
                  <p className="text-[11px] sm:text-xs text-slate-400 mt-0.5 hidden xs:block sm:block">
